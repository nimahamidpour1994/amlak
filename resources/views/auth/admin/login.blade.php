...
<head>
    ...
    <title>صفحه ورود مدیریت {{$response['app_name']}}</title>
    ...
    <div class="d-flex justify-content-center h-100 mt-5">
        <div class="user_card">
            ...
            <div class="d-flex justify-content-center">
                <div class="brand_logo_container rounded-circle">
                    <img src="{{url($response['app_logo'])}}" class="brand_logo" alt="{{$response['app_name']}}">
                </div>
            </div>
               ...
               <form method="POST" action="{{route('admin.login.submit')}}">
                   @csrf
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="mobile" class="font-iran form-control input_user" value="" placeholder="نام کاربری">
                    </div>
                    <div class="input-group mb-2">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                        </div>
                        <input type="password" name="password" class="font-iran form-control input_pass" value="" placeholder="کلمه عبور">
                    </div>
